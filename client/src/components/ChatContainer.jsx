...
const ChatContainer = ({selectedUser,setSelectedUser}) => {
  ...
  return selectedUser?(
    //this will render when selected user is true
    <div className='h-full flex flex-col relative backdrop-blur-2xl'>
      {/*-----header------*/}
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
       <img src={assets.profile_martin} alt="" className="w-9 rounded-full" />
       <p className='flex-1 text-base text-white flex items-center gap2'>
        Martin Johnson
    ...
    {/*-------------bottom area-------------*/}
      <div className="p-3 border-t border-stone-700 flex items-center gap-3 bg-black/40">
         <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
          <input type="text" placeholder="send a message" className='flex-1 text-sm p-3 
          border-none rounded-lg outline-none text-white placeholder
          -gray-400'/>
