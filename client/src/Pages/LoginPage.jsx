      ...
      <img src={assets.logo_big} alt="" className='w-[min(30vw,250px)]'/>
       ...
       flex flex-col gap-6 rounded-lg shadow-lg'>
         <h2 className='font-medium text-2xl flex justify-between items-center'>
          ...
          type="text" placeholder="Full Name"  required className='p-2 border border-gray-500 rounded-md
          focus:outline-none'  />
           )}
           ...
           {currState=== "Sign up"&& isDataSubmitted && (
            ...
            <div className='flex flex-col gap-2'>
              ...
              <p className='text-sm text-gray-600'>
               Create an account? <span onClick={()=>{setCurrState("Sign up");setIsDataSubmitted(false)}} 
